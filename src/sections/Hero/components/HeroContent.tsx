    ...
    <div className="items-start box-border caret-transparent flex flex-col gap-3 pb-8 px-4 md:px-0">
      ...
      >
        <a
          ...
          className={`${commonClasses.buttonPrimary} group relative inline-flex h-11 overflow-hidden px-4 pr-3 text-sm shadow-[0_10px_24px_rgba(0,0,0,0.10)] ring-1 ring-black/5`}
        >
